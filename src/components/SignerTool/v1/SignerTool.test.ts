...
const serviceOfferingTestData = require('../../../../assets/so_testcase.sample.json')
	...
	describe('Negative scenarios', () => {
		describe('Validation checks', () => {
			...
			it('Invalid issuer value', async () => {
				const { invalidIssuerJSON } = serviceOfferingTestData
				const error = {
			...
			it('Invalid verificationMethod value', async () => {
				const { invalidMerificationMethodJSON } = serviceOfferingTestData
				const error = {
			...
			it('Invalid serviceOffering object', async () => {
				const { invalidSO } = serviceOfferingTestData
				const error = {
